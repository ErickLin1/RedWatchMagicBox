...
public class ControlPanel extends SubsystemBase {
  ...
  public ControlPanel(DrivetrainSparks m_drivetrainSparks, DrivetrainTalons m_drivetrainTalons) { // Climber m_climber
    ...
    // m_ShuffleboardTab.add("LEFT Motors RPM", new SparkSpeedPID(m_drivetrainSparks, () -> LeftSparkRPM.getDouble(0))).withPosition(2, 3);
    m_ShuffleboardTab.add("LEFT Motors RPM", new SparkSpeedRPM(() -> LeftSparkRPM.getDouble(0), () -> 0, m_drivetrainSparks)).withPosition(2, 3);
