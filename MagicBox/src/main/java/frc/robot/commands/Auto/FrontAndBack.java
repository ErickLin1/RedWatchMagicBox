 ...
 * >>> Modified time: 2023-01-23 10:31:20
...
public class FrontAndBack extends CommandBase {
  private static Drivetrain m_drivetrainSubsystem;
  /** Creates a new Square. */
  public FrontAndBack(Drivetrain drivetrainSubsystem) {
  ...
  @Override
	public void initialize() {
		...
		m_drivetrainSubsystem.trajString = Paths.testPaths.ForwardAndBackward;
	}
