...
public class differentialDriveSparks extends CommandBase {
  ...
  public differentialDriveSparks(DoubleSupplier forwardSpeed, DoubleSupplier reverseSpeed, DoubleSupplier leftSpeed, 
  DoubleSupplier rightSpeed, DrivetrainSparks subsystem) {
